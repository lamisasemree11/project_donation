   ...
   <div class="sidebar-sticky">
            ...
            <form  class="form-sample">
             <div class="row">
                 <div class="form-group text-primary">
                   ...
                   <?php
                     $sql="Select * from don_for_patients where id_user=".$_GET["id"];
    ...
    <th>حالة التبرع</th>
         ...
         while($row=$result->fetch_assoc())
         {
           ...
           $sql2="Select * from patients where id=".$id_patient;
           ...
           echo "<td>".$row2['typeDisease']."</td>";
           echo "<td>".$row2['need_to']."</td>";
           echo "<td>".$row['don_value']." شيكل </td>";
           echo "<td>".$row['date_don']."</td>";
          echo "<td><a href='view_patient_det.php?id=".$_GET['id']."&id_patient=".$row2['id']."' class='btn btn-sm btn-primary'>تفاصيل المريض</a></td>";

 ...
 <section class="ftco-section"style="text-align:right;">
        ...
        <div style="margin-top:-50px;" class="row">
            <div class="col-lg-12 col-xs-12">
                <ol class="breadcrumb">
                  ...
                  <li style="margin-left:40px;"><a style="color:red;" href=<?php echo 'total_donations.php?id='.$row["id"];?>>التبرعات التي قمت بها</a></li>
                  ...
                  <li style="margin-left:40px;"><a href=<?php echo 'my_user_project.php?id='.$row["id"];?>>مشاريع مضافة</a></li>
   ...
   <div class="sidebar-sticky">
     <ul style="margin-bottom:50px;" class="nav flex-column">
       ...
       <li  class="nav-item">
         <a style="color:red;" class="nav-link" href=<?php echo 'user_general_don.php?id='.$row["id"];?>>التبرع العام</a>
       </li>
       <li class="nav-item">
            ...
            <form  class="form-sample">
             <div class="row">
                 <div class="form-group text-primary">
                   ...
                   <?php
                     $sql="Select * from general_don where id_user=".$_GET["id"];

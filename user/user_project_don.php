 ...
 <section class="ftco-section"style="text-align:right;">
        ...
        <div style="margin-top:-50px;" class="row">
            <div class="col-lg-12 col-xs-12">
                <ol class="breadcrumb">
                  ...
                  <li><a  href=<?php echo 'Search_donor.php?id='.$row["id"];?>>تغيير كلمة المرور</a></li>
                </ol>
            </div>
        </div>
   ...
   <div class="sidebar-sticky">
     <ul style="margin-bottom:50px;" class="nav flex-column">
       ...
       <li class="nav-item">
         <a style="color:red;" class="nav-link " href=<?php echo 'user_project_don.php?id='.$row["id"];?>> مشاريع صغيرة</a>
       </li>
       <li class="nav-item">
            ...
            <form  class="form-sample">
             <div class="row">
                 <div class="form-group text-primary">
                   ...
                   <?php
                     $sql="Select * from don_for_project where id_user=".$_GET["id"];
    ...
    <th>حالة التبرع</th>
         ...
         while($row=$result->fetch_assoc())
         {
           ...
           $sql2="Select * from smallproject where project_id=".$id_project;
           ...
           echo "<td>".$row2['project_owner']."</td>";
           echo "<td>".$row2['Total_amount']." شيكل </td>";

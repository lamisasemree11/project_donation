  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco-navbar-light" id="ftco-navbar" style="margin:0;">
   <div class="container d-flex align-items-center" >
      ...
      <div class="container"  style="margin-top:20px;">
        <div class="row">
        <div class="col-sm-7">
        <p style='padding-left:300px;color:black;font-size:22px;font-weight:bold;'> عنوان المشروع / <?php echo $row["project_title"] ; ?></p><hr>

        <?php
         echo "<img style='margin-left:300px;' width='500px;' src=images/".$row["project_img"].'>';
         ?>
         <br>
          <p style='color:blue;font-size:20px;font-weight:bold;margin-top:30px;margin-left:500px;'>وصف المشروع</p>
         <p style='color:black;font-size:20px;font-weight:bold;margin-top:30px;'><?php echo $row["project_Desc"] ; ?></p>

         <p style='color:blue;font-size:20px;font-weight:bold;margin-top:30px;margin-left:500px;'>مالك المشروع</p>
         <p style='color:black;font-size:20px;font-weight:bold;margin-left:400px;'><?php echo $row["project_owner"] ; ?></p>
        ...
        <br>
                  ...
                  <div class="col-sm-5">
                    ...
                    if(isset($_GET["id_project"]))
                    {
                      $sql="SELECT * FROM don_for_project WHERE id_project=".$_GET["id_project"];
                      $n=0;
                      $result=$conn->query($sql);
                      if($result->num_rows>0)
                      {

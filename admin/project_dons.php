 ...
 <nav  style="margin-right:-200px;margin-top:50px;" class="col-md-4 d-none d-md-block  sidebar">
   <div class="sidebar-sticky">
     <ul class="nav flex-column">
       ...
       <li class="nav-item">
         <a style="color:blue;"  class="nav-link " href="patient_don.php">التبرعات للمرضى</a>
       </li>
       <li class="nav-item">
         <a style="color:red;" class="nav-link " href="project_dons.php">التبرعات للمشاريع</a>
       </li>
       <li class="nav-item">

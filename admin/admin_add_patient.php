          ...
          <div class="col-md-10 mb-md-5">
            <?php
              if(isset($_POST['submit'])){
                ...
                $sql = "INSERT INTO `patients`(`fullName`,`gender`, `TotalِAmount`, `age`, `typeDisease`,`DescriptionDisease`,
                   `need_to`, `city`, `hospital`, `last_date_donate`)
                 VALUES ('$name','$gender', '$TotalِAmount', '$Age', '$typeDisease', '$DescriptionDisease', '$need_to', '$city',
                   '$hospital', '$last_date_donate')";
                $q = mysqli_query($conn , $sql);
                if ($q) {
                    echo "<div style='padding-left:300px;font-size:18px;font-weight:bold;' class='alert alert-success'>تم اضافة بيانات المريض بنجاح</div>";
                } else {
                    echo "<div style='padding-left:300px;font-size:18px;font-weight:bold;' class='alert alert-danger'>لم يتم الاضافة اعد المحاولة مجددا</div>";
                }
              }
            ?>
            <form class="border border-nowhite p-5 contact-form" method="post"  role="form" autocomplete="off">
              <h1 class="text-center" style="color:#00bdaa;">اضافة مريض جديد</h1>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control"  id="patientNum"  name="patientNum" >
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <h5 style="text-align:right; margin-right:10px;">المبلغ الاجمالي<h5>
                  <input type="number"  id="TotalِAmount"   name="TotalِAmount"  class="form-control">
              </div>
              <div class="form-group">
              ...
              <input type="text" = id="DescriptionDisease"   name="DescriptionDisease" class="form-control">
              </div>
              <div class="form-group">
                <h5 style="text-align:right; margin-right:10px;">يحتاج الى<h5>
                      <input type="text"  id="need_to"   name="need_to" class="form-control">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text"  id="patientHospital"   name="patientHospital" class="form-control">
              </div>
              <div class="form-group">
                <h5 style="text-align:right; margin-right:10px;">اخر موعد للتبرع<h5>
                  <input type="date"  id="last_date_donate"   name="last_date_donate" class="form-control">
              </div>
              <div class="form-group">
                <input type="submit"   name="submit" value="اضافة" class="btn py-3 px-4 btn-primary" style="width:100%;">
              </div>
            </form>
          </div>
        </div>

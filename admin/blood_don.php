...
?>
 ...
 <nav  style="margin-right:-200px;margin-top:100px;" class="col-md-4 d-none d-md-block  sidebar">
   <div class="sidebar-sticky">
     <ul class="nav flex-column">
       ...
       <li  class="nav-item">
         <a style="color:red;" class="nav-link" href="blood_don.php">عرض المتبرعين</a>
       </li>
       <li class="nav-item">
 ...
 <div style="padding-top:40px;padding-right:40px;" class="col-9">
   <h3 style="text-align:right;color:blue;" ><i class="fa fa-search"></i> بحث تفاصيل المتبرع </h3><hr>
<div class="row">
